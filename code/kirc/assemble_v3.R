...
## ===== Fig 8 and Fig 9 — standalone analysis figures =====
## These scripts save results/Fig_ML_SHAP.* and results/Fig_CellChat.*.
tryCatch(sys.source("code/kirc/fig_ml_shap.R", envir=new.env()),
         error=function(err) message("  (Fig8 ML/SHAP skipped: ", conditionMessage(err), ")"))
tryCatch(sys.source("code/kirc/fig_cellchat.R", envir=new.env()),
         error=function(err) message("  (Fig9 CellChat skipped: ", conditionMessage(err), ")"))
...
PUBMAP <- c(Fig1_landscape_v3="Figure1", Fig2_signature_v3="Figure2",
            Fig4_prognosis_subtype_v3="Figure3", Fig3_validation_v3="Figure4",
            Fig5_immune_v3="Figure5", Fig6_context_v3="Figure6", Fig7_therapy_v3="Figure7",
            Fig_ML_SHAP="Figure8", Fig_CellChat="Figure9")
...
cat("published 9 figures -> submission_BMC/{figures, figures_TIFF_300dpi}\n")
